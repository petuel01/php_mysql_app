...
<body>
        ...
        <div class="sidebar">
            <ul class="list">
               ...
               echo' <li class="item"><a href="customer.php" class="itemLink"><i class="fas fa-users" id="icon"></i>Customers</a></li>
                ...
                <li class="item"><a href="#" class=" hov itemLink" onclick="hover3()"><i class="fas fa-dollar-sign" id="icon"></i>Sales</a>
                <ul class="sublist3">
               
                        <li class="subitem"><a href="add-sales.php" class="sublink" ><i class="fas fa-plus"></i></i> Add Sales</a></li>
                        <li class="subitem"><a href="sales.php" class="hov sublink"><i class="fas fa-layer-group"></i> Manage Sales</a></li>
                    </ul>
                </li>
    ...
    <section class="down">
        <div class="head-pro">
            ...
            <button class="add"><a href="add-sale.php">Add Sales</a></button>
        </div>
        <div class="main-products">
            <div class="search">
                <button type="submit" id="search" class="search-btn">S</button>
            ...
            <table>
                <tr class="headth">
                  ...
                  if(isset($_POST['submit'])){
                    $search = $_POST['search'];
                    $sql = "select * from sales where id like '%$search%' or p_name like '%$search%'";
...
<script>
    ...
    function editRow( Qtt) {
        document.getElementById('editQtt').value = Qtt;
  ...
  // Remove the item from the table if the request is successful
  xhr.onload = function() {
    if (xhr.status == 200) {
